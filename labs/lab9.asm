; Q9: Write an Assembly Program to count the total number of 1's in a number stored at 2001H. Store the result in 2002H.
...
COUNT_LOOP:
    RAL     ; Rotate left
    JNC SKIP  ; If carry = 1, increment count
    INR C   ; C ← C + 1
